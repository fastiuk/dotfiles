...
if [ "$color_prompt" = yes ]; then
    PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;33m\]$(parse_git_branch)\[\033[00m\]\`if [ \$? = 0 ]; then echo \[\e[32m\] ^_^ \[\e[0m\]; else echo \[\e[31m\] O_O \[\e[0m\]; fi\`\$ "
else
    PS1='${debian_chroot:+($debian_chroot)}\u@\h:\w$(parse_git_branch)\`if [ \$? = 0 ]; then echo \[\e[32m\] ^_^ \[\e[0m\]; else echo \[\e[31m\] O_O \[\e[0m\]; fi\`\$ '
fi
